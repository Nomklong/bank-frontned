...
import {deposit} from "../apis/wallet";
...
export function Deposit(): JSX.Element {
    ...
    const [open, setSuccessDeposit] = React.useState(false);
    const [fail, setFailDeposit] = React.useState(false);
    ...
    React.useEffect(() => {
        ...
        deposit(parameters, token).then((data) => {
